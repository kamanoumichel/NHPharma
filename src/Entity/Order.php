...
class Order
{
    ...
    #[ORM\ManyToOne(inversedBy: 'transporterName')]
    ...
    #[ORM\Column]
    private ?int $transporterPrice = null;
    ...
    public function getTransporterPrice(): ?int
    {
        return $this->transporterPrice;
    }

    public function setTransporterPrice(int $transporterPrice): static
    {
